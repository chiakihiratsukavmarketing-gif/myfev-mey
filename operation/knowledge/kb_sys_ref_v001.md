...
### 基本プロフィール
- アカウントのテーマ：AI活用
- 主な読者層：AIツールに興味がある一般ユーザー
- 発信の目的：AI活用のリアルな体験・気づきをシェアする

### 語調・文体
- 口調：友達感覚・フレンドリー
- よく使う語尾・表現：「〜だよ」「いる？」「すごくない？」
- 文章の長さ：短め・テンポよく

### 使いたい表現・禁止表現
- 積極的に使いたいワード：「AI」「使ってみた」「これ知ってる？」「正直」
- 絶対に使わないワード：「稼ぐ」「副業で月〇万」「収益化」
- 避けたいトーン：煽り・マウント・過度な数字アピール
