...
- 1回で契約しようとすると相手も身構える。初回ヒアリング→提案→契約確認と3回に分けてから、成約率が体感でかなり上がった
- 初回ヒアリングは90分とる。「何に困ってるか」だけじゃなくて「何をゴールとするか」「予算はいくらか」まで確認してから提案するようにした
- 提案書はA4一枚にまとめてる。課題・施策・KPI・期間・費用の5つだけ。ごちゃごちゃした長い資料より相手に刺さる
...
- 値上げを伝えるとき「今の価格でそのまま続ける」か「少し上がる代わりにリール追加・広告運用もつける強化プラン」かを選んでもらう。どっちかを選ぶ形にするとスムーズに進む
...
3. **AI情報の幅**：無料AI（Claude・ChatGPT・Gemini・Perplexity）も有料AI（Claude Pro・ChatGPT Plus・Notion AI・Adobe Firefly等）もどちらも積極的に紹介してOK。「有料にしたら作業が激変した」という体験談も歓迎
